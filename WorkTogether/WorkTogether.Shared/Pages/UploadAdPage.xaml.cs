...
namespace WorkTogether.Pages
{
    ...
    /// </summary>
    public sealed partial class UploadAdPage : Page
    {
        private NavigationHelper navigationHelper;
        private ObservableDictionary defaultViewModel = new ObservableDictionary();

        public UploadAdPage()
            :this(new UploadAdPageViewModel())
        {

        }
        public UploadAdPage(UploadAdPageViewModel viewModel)
        {
        ...
        public UploadAdPageViewModel ViewModel
        {
            get
            {
                return this.DataContext as UploadAdPageViewModel;
            }
            set
            {
